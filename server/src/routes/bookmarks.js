...
router.post("/", optionalAuth, bookmarkController.addBookmark); 

// Route to get all bookmarks for a specific user and post type
router.get("/:userId", optionalAuth, bookmarkController.getAllBookmarks);
// Route to remove a bookmark by its ID
router.delete("/:id", optionalAuth, bookmarkController.removeBookmark); 
