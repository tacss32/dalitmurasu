...
interface GroupedImages {
    [monthYear: string]: CartoonsImage[];
}
...
function CartoonsPage() {
    ...
    const [images, setImages] = useState<CartoonsImage[]>([]);
    ...
    const groupImagesByMonth = (allImages: CartoonsImage[]): GroupedImages => {
    ...
    `}
                                        >
                                            ...
                                            <div
                                                onClick={() => navigate(`/cartoons/${img._id}`)}
                ...
                <p className="text-center text-gray-400">
                    The cartoons is currently empty.
                </p>
            )}
