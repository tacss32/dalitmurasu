                  ...
                  return (
                    ...
                    >
                      ...
                      <img
                        ...
                        alt={img.title}
                        loading="lazy"
                        className="absolute inset-0 w-full h-full object-cover transition-transform duration-300 ease-in-out group-hover:scale-105 z-10 px-4 sm:px-6 rounded-lg"
                      />
