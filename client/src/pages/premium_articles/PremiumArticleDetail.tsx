...
  // Function to fetch bookmark status (defined here to be used in handleBookmark)
...
      // If bookmarkId is not set, we try to find it first
      try {
...
        }
      } catch (error) {
        toast.error("Error confirming bookmark status.");
        return;
      }
    }
