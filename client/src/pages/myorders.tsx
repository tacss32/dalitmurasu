...
                        <div
                            key={order._id}
                            className="p-6 border rounded-xl shadow-md bg-background-to hover:shadow-lg transition"
                        >
                            {/* Header */}
...
                            {/* Items */}
                            <div className="mt-4">
                                <h4 className="font-semibold text-gray-700 text-2xl">Items:</h4>
                                <ul className="list-disc list-inside text-lg text-gray-700 mt-1 space-y-1">
...
                                <div className="flex justify-between items-center mt-2 text-2xl text-gray-700 font-bold">
