...
        </div>
       
            {/* // --- MODIFIED DESKTOP ICONS (Moved to be absolute) --- 
            // The desktop icons are correctly positioned absolutely and remain untouched. 
            // The original two mobile icon blocks were removed and replaced with the one above.
            */}
...
          </button>
        </div>
        {/* The second mobile-only button block was removed:
