    ...
    <div className="max-w-4xl mx-auto p-4 flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-3 py-6 border-b-4 border-highlight-1 relative">
        ...
        <div className="flex items-center justify-between"> 
          ...
          <button
            onClick={handleShare}
            // Visible on mobile (flex) and hidden on desktop (md:hidden)
            className="flex md:hidden group bg-highlight-1 text-white hover:bg-highlight-1/80 p-2 rounded-full shadow-md transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50 items-center justify-center"
